...
function mostrarInstrucciones(instrucciones) {
  ...
  for (var i = 0; i < instrucciones.length; i++) {
    ...
    nuevoLi.textContent = instrucciones[i];
    listaInstrucciones.appendChild(nuevoLi);
  }
  // COMPLETO
}
...
function mostrarCartelGanador() {
  if (chequearSiGano()) {
    return alert("Usted ha ganado el juego!!!\nFELICIDADES!!!")
  }
  // COMPLETO
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var grillaTemp = [[]];
  grillaTemp[0][0] = grilla[filaPos1][columnaPos1];
  //console.log(grilla[filaPos1][columnaPos1]+" "+grillaTemp[0][0]);
  grilla[filaPos1][columnaPos1]=grilla[filaPos2][columnaPos2];
  //console.log(grilla[filaPos1][columnaPos1]+" "+grilla[filaPos2][columnaPos2]+" ");
  grilla[filaPos2][columnaPos2]=grillaTemp[0][0];
  //console.log(grilla[filaPos2][columnaPos2]+" "+grillaTemp[0][0]);
  // COMPLETO
}
